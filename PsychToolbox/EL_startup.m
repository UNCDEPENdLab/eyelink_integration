function [el] = EL_startup(window, dummy_mode, edf_file, init_msg, calibration_type, sample_rate, run_calibration, use_ellipse)
...
if nargin < 8, use_ellipse=false; end %default to centroid
